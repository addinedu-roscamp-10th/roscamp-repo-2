    ...
    gz::sim::EntityComponentManager & /*_ecm*/)
{
    ...
    if (currentTime - last_update_time_ >= 0.1)
    {
        ...
        auto pub = node_.Advertise<gz::msgs::MaterialColor>("/world/TAT_factory/material_color");
...
GZ_ADD_PLUGIN(
    TAT_gz_sim::LampControlPlugin,
    gz::sim::System,
    TAT_gz_sim::LampControlPlugin::ISystemConfigure,
    TAT_gz_sim::LampControlPlugin::ISystemPreUpdate)
