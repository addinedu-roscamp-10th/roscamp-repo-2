...
import { ClipboardList, FlaskConical, Factory, LayoutDashboard } from "lucide-react";
...
// 2026-05-15: /admin/dashboard 운영 대시보드 복귀.
const navItems = [
  { href: "/admin/dashboard", label: "운영 대시보드", icon: LayoutDashboard },
