...
export const mockInspections: InspectionRecord[] = [
  ...
  { id: "INS-004", productId: "PRD-001", castingId: "CST-0298-04", orderId: "ORD-2026-004", result: "fail", defectTypeCode: "D00", confidence: 99.1, inspectorId: "CAM-001", imageId: "IMG-004", inspectedAt: "2026-03-30T09:34:00", defectType: "표면 결함", defectDetail: "외관 비전 검사에서 결함 감지" },
  ...
  { id: "INS-008", productId: "PRD-001", castingId: "CST-0298-08", orderId: "ORD-2026-004", result: "fail", defectTypeCode: "D00", confidence: 97.5, inspectorId: "CAM-001", imageId: "IMG-008", inspectedAt: "2026-03-30T09:38:00", defectType: "표면 결함", defectDetail: "외관 비전 검사에서 결함 감지" },
