...
from app.generated import management_pb2 as management__pb2
...
class ManagementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReportRfidScan = channel.unary_unary(
                ...
                _registered_method=True)
        self.ReportConveyorEvent = channel.unary_unary(
                '/casting.management.v1.ManagementService/ReportConveyorEvent',
                request_serializer=management__pb2.ConveyorEvent.SerializeToString,
                response_deserializer=management__pb2.ConveyorEventAck.FromString,
                _registered_method=True)
...
def add_ManagementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReportConveyorEvent': grpc.unary_unary_rpc_method_handler(
                    servicer.ReportConveyorEvent,
                    request_deserializer=management__pb2.ConveyorEvent.FromString,
                    response_serializer=management__pb2.ConveyorEventAck.SerializeToString,
            ),
...
class ManagementService(object):
    ...
    @staticmethod
    def ReportConveyorEvent(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/casting.management.v1.ManagementService/ReportConveyorEvent',
            management__pb2.ConveyorEvent.SerializeToString,
            management__pb2.ConveyorEventAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
